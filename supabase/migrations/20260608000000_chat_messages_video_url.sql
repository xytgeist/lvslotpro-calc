-- Add video_url column for direct R2 video uploads in chat (bypasses CF Stream).
-- Rebuilds chat_messages_page and chat_messages_window to expose the new column.
-- Legacy messages with stream_video_uid continue to work unchanged.
