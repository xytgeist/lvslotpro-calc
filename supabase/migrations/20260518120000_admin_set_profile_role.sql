-- Admin-only in-app path to promote/demote profiles.role (moderator / user).
-- Caller must have profiles.role = 'admin'. Works with existing trg_profiles_enforce_role.
