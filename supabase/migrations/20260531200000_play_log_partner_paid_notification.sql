-- Play Logbook — notify partner when owner/manager marks them paid.
...
-- Full session edit: notify when paid flips false → true (snapshot before partner rows are replaced).
