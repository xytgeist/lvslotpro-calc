-- Phase J (slice): home feed Popular sort — weighted engagement + time decay (server-side).
-- Apply on test after feed interaction counters exist on community_feed_posts.
-- Client: loungeFeedSortPref.js, loungeFeedScope.js (RPC page fetch), AppShell.jsx.
