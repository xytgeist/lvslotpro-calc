  ...
  return (
    <div className="min-h-screen bg-slate-950 pb-12">
      <div className="max-w-lg mx-auto px-4 pt-6">
        ...
        {/* Title with back button + Ascending Fortunes - taller text, less top padding */}
        <div className="flex items-center mb-8">
          ...
          <div className="flex items-center flex-1 justify-center gap-3">
            ...
            <div className="flex flex-col items-center -space-y-[6px] -mt-1">
              <h1 className="font-montserrat text-[34px] font-bold tracking-[-1.4px] text-cyan-100">
                STACK UP PAYS
              </h1>
              <p className="text-cyan-300/90 text-[18px] font-semibold tracking-[1px]">
                ASCENDING FORTUNES
              </p>
            </div>
          </div>
