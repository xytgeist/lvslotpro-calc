...
function PhoenixLink({ onBack }) {
  ...
  return (
    <div className="min-h-screen bg-gray-950 pb-12">
      {/* Main Content - very tight spacing under LAS VEGAS SLOT PRO bar */}
      <div className="pt-14 max-w-lg mx-auto px-4">
        ...
        {/* The rest of your content (Advanced Settings, Current EV, Acquisition Fee, Walk-Away, EV Table, etc.) remains unchanged */}
        {/* Advanced Settings */}
        ...
        {/* Current EV, Acquisition Fee, Walk-Away Advisor, EV Table sections remain exactly the same as in your original file */}
        {/* ... (copy the rest of the sections from your provided PhoenixLink.jsx here) ... */}
