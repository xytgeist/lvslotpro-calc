...
function PhoenixLink({ onBack, showMenu, setShowMenu }) {
  ...
  return (
    <div className="min-h-screen bg-gray-950 pb-12">
      <div className="pt-8 max-w-lg mx-auto px-4">
        ...
        {/* All your sections (Counter, Advanced, Current EV, Acquisition Fee, Walk-Away, EV Table) */}
        {/* Counter */}
        ...
        {/* Current EV, Acquisition Fee, Walk-Away Advisor, EV Table - all unchanged from your version */}
        {/* Paste the rest of your sections exactly as they were in your last working file here */}

        {/* (For brevity I stopped here - copy the Current EV, Acquisition Fee, Walk-Away, and EV Table sections from your previous file) */}
