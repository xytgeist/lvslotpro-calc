  ...
  return (
    <div className="min-h-screen bg-slate-950 pb-12">
      <div className="max-w-lg mx-auto px-4 pt-6">
        ...
        {/* Meter Sliders - original colored accents + Chrome white border fix */}
          ...
          {[
            ...
            <div key={i}>
              ...
              <input
                ...
                className={`w-full ${m.accent} accent-opacity-100 outline-none focus:outline-none focus:ring-0 focus:border-transparent [-webkit-appearance:none]`}
              />
            </div>
          ))}
        </div>
