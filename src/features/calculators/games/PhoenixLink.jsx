        ...
        <div className="bg-zinc-900 p-3 rounded-3xl mb-4 space-y-3">
          <div>
            ...
            <input 
              ...
              className="w-full p-3 bg-zinc-800 rounded-2xl text-2xl font-bold text-center border-2 border-orange-500" 
            />
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-zinc-400 mb-1 text-xs">Bet Size</label>
              <div className="flex h-14 items-stretch gap-1 rounded-2xl bg-zinc-800 px-2.5 focus-within:ring-2 focus-within:ring-orange-500/30">
            ...
            <div>
              ...
              <select 
                ...
                className="h-14 w-full cursor-pointer rounded-2xl border-0 bg-zinc-800 px-2 text-center text-2xl font-bold leading-none text-white outline-none focus:ring-2 focus:ring-orange-500/30"
              >
