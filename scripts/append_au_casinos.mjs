...
const csv = readFileSync('C:/Users/Ryan Franklin/Downloads/au_casinos.csv', 'utf8')
...
console.log(`Appended ${names.length} Australian casinos (${lines.length - names.length} dupes removed)`)
