...
const csv = readFileSync('C:/Users/Ryan Franklin/Downloads/asia_casinos.csv', 'utf8')
...
console.log(`Appended ${names.length} Asian casinos (${lines.length - names.length} dupes removed)`)
