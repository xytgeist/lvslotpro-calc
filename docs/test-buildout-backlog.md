...
- 2026-05-29: **Play Logbook — partner paid notification:** migration **`20260531200000_play_log_partner_paid_notification.sql`** + Edge **`lounge-send-activity-push`** — **`play_log_partner_paid`** activity + push when owner/manager marks a registered partner paid (false→true only). Redeploy Edge after SQL.
