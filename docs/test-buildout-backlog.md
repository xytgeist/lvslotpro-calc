...
- 2026-05-29: **Play Logbook — partner paid/unpaid notifications:** migrations **`20260531200000`** / repair **`20260531300000`** (paid, false→true) + **`20260531310000_play_log_partner_unpaid_notification.sql`** (unpaid, true→false) + Edge **`lounge-send-activity-push`** — **`play_log_partner_paid`** / **`play_log_partner_unpaid`** activity + push when owner/manager toggles a registered partner’s paid flag. Redeploy Edge after SQL.
